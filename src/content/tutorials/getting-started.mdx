...
summary: "Take a feature from a rough idea to working code using a Spektacular spek, the project knowledge base, and a plan-and-implement loop driven by your coding agent of choice."
order: 10
---
import Step from "../../components/sections/Step.astro"; import
AgentBlock from "../../components/tutorial/AgentBlock.astro"; import ZoomImage
from "../../components/tutorial/ZoomImage.astro"; import YouTubeVideo from
"../../components/tutorial/YouTubeVideo.astro";
...
In this tutorial you will see how Spektacular (Spek)'s Spec Driven Development workflow
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={0} end={107} fullscreen={true} />

<Step spaced number="1" heading="Cloning the example repository">
...
<Step spaced number="2" heading="Install Spektacular (Spek)">
...
<Step spaced number="3" heading="Install and configure your coding agent">
...
<Step spaced number="4" heading="Initialise your project">
  ...
  [Multi-Repo Projects](/projects/) to learn how.
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={108} end={151} fullscreen={true} />
...
following shows the config for the spek storage section.
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={152} end={215} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={216} end={254} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={255} end={299} fullscreen={true} />
...
At no point have we defined any technical implementation details. The spek's job
is to describe what the system must do, not how it does it. The moment you put a
code snippet in a spek, you are making an implementation decision that belongs to
the agent.
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={300} end={350} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={351} end={406} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={407} end={446} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={447} end={501} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={502} end={585} fullscreen={true} />
...
spek store (in this case `.spektacular/specs/`). You can open the file
...
<Step spaced number="1" heading="Context Cancellation">
...
<Step spaced number="2" heading="Dependency Injection">
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={586} end={1103} fullscreen={true} />
...
<YouTubeVideo url="https://youtu.be/ZRVa9gml_Bg" start={1104} fullscreen={true} />
