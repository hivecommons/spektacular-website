...
<Section heading="Implementing one task" surface>
  ...
  `"task": "<id>"` beside the plan's address and location:

  ```json
  {
    "plan_name": "000058_plan-task-graph",
    "plan_document": "plan",
    "plan_path": "plans/000058_plan-task-graph/plan.md",
    "task": "7c1e4b0a-9d3f-4e2a-8b61-0f5d2c9a7e34"
  }
  ```
  ...
  `config.yaml`, never an absolute host path. See [Documents](/documents/).
